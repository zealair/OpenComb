...
jQuery(function($){
	...
	var shipdownloads = [
		...
		, "ocPlatform/lib/frontend/mvc/ViewTemplate.js"
	...
	var initOpenComb = function() {
		...
		jQuery.shipper.module("ocPlatform/lib/frontend/patchs.js") ;


		// 初始化视图
		var View = jQuery.shipper.module("ocPlatform/lib/frontend/mvc/View.js") ;
		...
		jQuery.shipper.module("ocPlatform/lib/frontend/mvc/Director.js") ;
		jQuery.director.setup() ;

		var ViewTemplate = jQuery.shipper.module("ocPlatform/lib/frontend/mvc/ViewTemplate.js") ;
	...
	{
		jQuery.shipper.require(shipdownloads[i],function(err,path,module){
