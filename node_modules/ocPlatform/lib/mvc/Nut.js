...
var Nut = module.exports = function(controller,rsp)
{
	this.rsp = rsp ;
 ...
 *
 */
Nut.prototype.release = function()
{
	this.rsp = null ;
	this.model = null ;
	this.view.release() ;
...
{
	nut.assembleView = Nut.prototype.assembleView ;
	nut.release = Nut.prototype.release ;
	nut.cleanup = Nut.prototype.cleanup ;
	nut.render = Nut.prototype.render ;
	nut.constructor = Nut ;
...
Nut.prototype.crack = function(callback)
{
	this.rsp.wait() ;
	var nut = this ;
