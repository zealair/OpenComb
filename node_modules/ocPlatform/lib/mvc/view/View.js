...
module.exports.prototype.createWrapperHead = function(tagName)
{
	...
	{
		html+= ' onviewshow="'+this.tpl.onshowScript+'"' ;
	}
	html+= ">" ;
...
module.exports.restore = function(view,callback)
{
	...
	if(view.tpl)
	{
		FrontendViewTemplate.Caches.singleton.template(view.tpl,function(err,tpl){

			view.tpl = tpl ;
			if(tpl)
			{
				view.tpl.onshowScript = view.onshowScript ;
			}
...
module.exports.prototype.cleanup = function()
{
	if(this.tpl)
	{
		this.onshowScript = this.tpl.onshowScript ;
