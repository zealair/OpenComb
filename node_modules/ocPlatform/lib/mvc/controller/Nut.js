...
{
	// view and model
	this.view = new View(controller.viewTpl) ;
...
Nut.restore = function(nut,callback)
{
	...
	(function processChild(err,child){
		...
		else if( !childNames.length )
		{
			...
			if(nut.view.tpl)
			{
				FrontendViewTemplate.Caches.singleton.template(nut.view.tpl,function(err,tpl){
					if(!err)
					{
						nut.view = new View(tpl) ;
						nut.view.model.__proto__ = nut.model ;
