var AOP = require("aopjs/lib/aop.js") ;
exports.factory = function()
{
    var aop = AOP.createCallableInstance() ;
    aop.setup(require("module")) ;

    aop.before = function(joint,advice)
    {
    ...
    aop.after = function(joint,advice)
    {
	return joint? function(){
    ...
    aop.around = function(joint,advice)
    {
    ...
    aop.watch = function(object,propertyName,setter,getter)
    {
	// setup
