...
module.exports = function(){
	...
	this._ocFrameworkFrontendRequires = [
		"ocplatform/public/lib/oc/patchs.js"
		, "octemplate/lib/TemplateCaches.js"
		, "ocplatform/lib/mvc/view/ViewTemplateCaches.js"
		, "ocplatform/public/lib/oc/mvc/View.js"
		, "ocplatform/public/lib/oc/mvc/ViewTemplate.js"
		, "ocplatform/public/lib/oc/mvc/Director.js"
		, "ocplatform/public/lib/oc/mvc/Switcher.js"
		, "ocplatform/lib/mvc/Validator.js"
	] ;
}

module.exports.prototype.addFrontEntranceFile = function(path)
{
	this._ocFrameworkFrontendRequires.push(path) ;
}
	...
	Step(
		...
		, function parseRequireDeps(err,buff){
			...
			if( !$opencomb.config.dev.frontend.dontBundle )
			{
				...
				var modules = [] ;
				var waitingloads = [] ;
				for(var i=0;i<this._ocFrameworkFrontendRequires.length;i++)
				{
					waitingloads.push(this._ocFrameworkFrontendRequires[i]) ;
				}
		...
		{
			shipper._frontendFrameworkCode+= "/*---*/window.__ocFrameworkFrontendRequires = " + JSON.stringify(shipper._ocFrameworkFrontendRequires) + ";\r\n\r\n\r\n" ;
