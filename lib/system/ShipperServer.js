...
{		
	...
	Steps(
		...
		function (){
			fs.readFile( require.resolve("ocplatform/public/lib/oc/ShipperClient.js"), this.hold('errShipperClient','buffShipperClient') ) ;
			fs.readFile( require.resolve("ocplatform/public/lib/oc/entrance.js"), this.hold() ) ;
		}
