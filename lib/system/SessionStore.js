...
module.exports.prototype.get = function(sid,callback)
{
	...
	this.platform.db.collection("sessions",'ocPlatform').find({'_id':sid},function(err,cursor){
		if(err)
		{
...
module.exports.prototype.set = function(sid, session, callback)
{
	...
	this.platform.db.collection("sessions",'ocPlatform').save(session, {safe:true}, callback);
}
...
module.exports.prototype.destroy = function(sid, callback)
{
	...
	this.platform.db.collection("sessions",'ocPlatform').findAndRemove({_id:sid}, {safe:true}, callback);
}