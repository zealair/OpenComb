...
{		
	...
	Steps(
		...
		function (){
			fs.readFile( require.resolve("opencomb/public/lib/oc/ShipperClient.js"), this.hold('errShipperClient','buffShipperClient') ) ;
			fs.readFile( require.resolve("opencomb/public/lib/oc/entrance.js"), this.hold() ) ;
		}
