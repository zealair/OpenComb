...
var View = require("../mvc/view/View.js") ;
...
module.exports = function(){
	...
	this._opencombFrontendRequires = [
		"opencomb/public/lib/oc/patchs.js"
		, "opencomb/lib/core/reset.js"
		, "octemplate/lib/TemplateCaches.js"
		, "opencomb/lib/mvc/view/ViewTemplateCaches.js"
		, "opencomb/public/lib/oc/mvc/View.js"
		, "opencomb/public/lib/oc/mvc/ViewTemplate.js"
		, "opencomb/public/lib/oc/mvc/Director.js"
		, "opencomb/public/lib/oc/mvc/Switcher.js"
		, "opencomb/lib/mvc/Validator.js"
	] ;
}

module.exports.prototype.addFrontEntranceFile = function(path)
{
	shipper._opencombFrontendRequires.push(path) ;
}
...
module.exports.prototype.buildFrontendFramework = function(bundle,callback)
{
	...
	Steps(
		...
		function (){
			fs.readFile( require.resolve("../../public/lib/oc/ShipperClient.js"), this.hold('errShipperClient','buffShipperClient') ) ;
			fs.readFile( require.resolve("../../public/lib/oc/entrance.js"), this.hold() ) ;
		}
		...
		, function (err,buff){
			...
			shipper._frontendFrameworkCode+= buff.toString().replace('{/*frontend configure*/}',JSON.stringify(Application.singleton.config.frontend)) + "\r\n\r\n\r\n" ;
		...
		, function parseRequireDeps(){
			...
			var modules = [] ;
			var waitingloads = [] ;
			for(var i=0;i<shipper._opencombFrontendRequires.length;i++)
			{
				waitingloads.push(shipper._opencombFrontendRequires[i]) ;
			}
		...
		{
			shipper._frontendFrameworkCode+= "/*---*/window.__opencombFrontendRequires = "
				+ JSON.stringify(shipper._opencombFrontendRequires)
				+ ";\r\n\r\n\r\n" ;
	...
	while( res=regexp.exec(source) )
	{
		...
		if(res2[1][0]!=".")
		{
			try{
				...
				if(!deppath || (deppath[0]!="/" && deppath[1]!=":"))
				{
					continue ;
				}
			} catch(e) {
...
var makePath = function(path,from){
	...
	if(path[0]==".")
	{
		var retpath =  _pt.normalize(_pt.dirname(from)+"/"+path) ;
	}
	else
	{
		var retpath = _pt.normalize(path) ;
	}
		...
		fs.readFile(path,function(err,buff){
			...
			if( Application.singleton.config.dev.watching.shipdown )
			{
				...
				fs.watchFile(path,function(){
					helper.log.info( (new Date).toISOString()+' Shipdown script has changed(auto reload): '+path ) ;
