...
module.exports.prototype.pathname = function(fullpath){

	var pkg = this.root.locate(fullpath) ;
	if(!pkg)
		return null ;
	var innerPath = fullpath.substr(pkg.folder.length+1) ;
	return pkg.name + "/" + innerPath ;
}