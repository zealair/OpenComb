module.exports = {
	...
	layout: "controlpanel"
	, view: "ocplatform/templates/usr/GroupList.html"
	, process: function(seed,nut,earth)
	{
		earth.hold().db.collection("ocplatform/groups")
			.find()
			.sort({path:-1})
	...
	, actions: {
		...
		form: {	
			layout: "controlpanel"
			, view: "ocplatform/templates/usr/GroupForm.html"
			, process: function(seed,nut,earth)
			{
		...
		, save: {
			...
			, process: function(seed,nut,earth)
			{
				...
				if( seed.parent )
				{
					earth.hold().db.collection("ocplatform/groups").findOne(
		...
		, del: function(seed,nut,earth)
		{
			...
			earth.hold().db.collection("ocplatform/groups").remove(
