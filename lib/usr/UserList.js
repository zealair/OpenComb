module.exports = {
	...
	layout: "controlpanel"
	, view: "ocplatform/templates/usr/UserList.html"
	...
	, children: {
		...
		page: {
			layout: "controlpanel"
			, view: "ocplatform/templates/usr/UserListPage.html"
			, process: function(seed,nut,earth)
			{
				...
				earth.hold().db.collection("ocplatform/users").find(condition).page(20,seed.page,function(err,page){
					if(err)
					{
						console.log(err) ;
					}
	...
	, actions: {
		...
		view: {
			...
			layout: "controlpanel"
			, view: "ocplatform/templates/usr/UserView.html"
			, process: function(seed,nut,earth)
			{
				if(!seed._id)
				{
				...
				earth.hold().db.collection("ocplatform/users")
