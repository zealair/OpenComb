...
exports.ControllerPath.prototype.loadDefine = function(){
    ...
    // 加载自己
    define._fullpath || (define._fullpath=this.fullpath) ;
...
exports.loadDefine = function(define,fullpath){
...
exports.loadDefineRecurse = function(define){
	...
	try{
	    var mbrDefine = exports.loadDefine( mbrDefine ) ;
	    ...
	    if(innerDefine)
                mbrDefine.setParentDefine(define,name) ;
    ...
    {
	loadMemberController( define.layout||'weblayout', define, 'layout' ) ;
    }

    // children
    for( var name in define.children )
    {
	loadMemberController( define.children[name], define.children, name ) ;
    }

    // actions
    for( var name in define.actions )
    {
	loadMemberController( define.actions[name], define.actions, name ) ;
    }
