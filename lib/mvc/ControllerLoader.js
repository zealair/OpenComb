...
var Application ;
function app(){
    return (Application||(Application = require("../core/Application.js"))).singleton ;
}
...
exports.resolve = function (path,from)
{
    ...
    return app().packages.resolve(path,from,'controller') ;
...
exports._loadView = function _loadView(controller,callback){
	...
	{
		app().templates.template(controller.view,function(err,tpl){
...
exports._loadDone = function(controller)
{
	...
	while( (callback=controller._initCallbacks.shift())!==undefined )
	{
        ...
        {
            app().helper.logger.error(controller._initializeErr) ;
        }
