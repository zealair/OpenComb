...
var Nut = module.exports = function(controller)
{
	...
	this.view.viewscript =	(controller.frontend &&
								(  controller.frontend.viewInit
								|| controller.frontend.viewIn
								|| controller.frontend.viewOut )
							)? true: false ;
}
...
Nut.prototype.crack = function(callback,inWebpage)
{
	...
	if(inWebpage)
	{
		...
		ViewTemplateCaches.singleton().template("ocplatform/templates/WebPage.html",function(err,webpage){
