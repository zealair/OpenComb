...
var Controller = module.exports = Class.extend({
	...
	, _loadView: function(callback){
		...
		TemplateCaches.singleton.template(this.view,function(err,tpl){
			controller.viewTpl = tpl ;
			callback(err,controller) ;
		}) ;
	}
...
,{
	...
	, load: function(define,callback,pathname){
		...
		if(typeof define=="string")
		{
			...
			{
				callback && callback(new Error(fullpath+"文件没有声明 module.exports.__as_controller=true ，不能被视作控制器。"),null) ;
				return ;
			}
...
Controller.append = function(parentpath,childpath,childname,callback)
{
...
Controller.registerAlias = function(alisa,controllerpath)
{
