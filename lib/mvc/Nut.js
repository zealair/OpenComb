...
{
	var nut = this ;
	TemplateCaches.singleton.template(tplpath,function(err,tpl){
		if( err )
		{
			callback && callback(err) ;
			return ;
		}
		console.log("createViewFromTemplate",nut.model);
...
Nut.prototype.crack = function(callback,inWebpage)
{
	...
	if(inWebpage)
	{
		...
		TemplateCaches.singleton.template("opencomb/templates/WebPage.html",function(err,webpage){
