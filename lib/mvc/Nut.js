...
Nut.prototype.disable = function(disabled) {
...
Nut.prototype.crack = function(callback,inWebpage)
{
    ...
    if(inWebpage)
    {
        ...
        helper && helper.log("nut").trace("before load template: opencomb/templates/WebPage.html") ;
        tplCache().template(this.WebPage || "opencomb/templates/WebPage.html",function(err,webpage){

            helper && helper.log("nut").trace("after load template: opencomb/templates/WebPage.html") ;
            ...
            helper && helper.log("nut").trace("before render view template: opencomb/templates/WebPage.html") ;
            webpagectx.render(function(err){

                helper && helper.log("nut").trace("after render view template: opencomb/templates/WebPage.html") ;
