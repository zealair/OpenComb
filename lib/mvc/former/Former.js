...
module.exports.prototype.remove = typex.overload(
	 ...
	 */
	["any","any","any"], function(opts,condition,done)
	{
		if(opts)
	 ...
	 * function(opts,done)
	 */
	, ["object","function"], function(opts,done){
		return this.remove(opts,null,done) ;
	}
	 ...
	 */
	, ["function"], function(done){
		return this.remove(null,null,done) ;
	}
	 ...
	 */
	, ["object"], function(opts){
		return this.remove(opts,null,null) ;
	}
	 ...
	 */
	, [], function(){
		return this.remove(undefined,undefined,undefined) ;
	}
) ;
