...
function application(){
    return (Application||(Application = (require||0)("../../core/Application.js"))).singleton ;
}

exports.init = function(caches)
{
	caches = caches || require("octemplate") ;
	...
	caches.template = function(filename,callback,from)
	{
		...
		return originTemplateMethod.call(this,filename,function(err,tpl,iscache){
            ...
            var app = application() ;
			if( tpl && typeof app!='undefined' && app.config.dev.watching.template && !iscache )
			{
				// 写入文件后，从文件加载，便于bug
