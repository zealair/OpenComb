...
exports.Prototype = {
	...
	, mockupEarth: function(req,rsp,platform)
	{
		var mock = require("mocks") ;

		var req = new mock.http.ServerRequest({url:"http://127.0.0.1/hello"}) ;
		var rsp = new mock.http.ServerResponse ;
		rsp._buff = '' ;
		rsp.write = function(txt)
		{
			this._buff+= txt ;
		}
		rsp.end = function(){}

		return this.createEarth(req,rsp) ;
	}
...
{
	var controller = ControllerLoader.loadDefine(path) ;
