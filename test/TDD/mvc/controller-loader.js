...
suite('mvc', function(){
	suite('#ControllerLoader', function(){
		...
		test('##ControllerPath', function(done){
			...
			(new loader.ControllerPath("opencomb/test/TDD/mvc/data/ControllerA")).fullpath.should.eql(__dirname+"/data/ControllerA.js") ;
			...
			(new loader.ControllerPath("opencomb/test/TDD/mvc/data/ControllerA:bbb")).fullpath.should.eql(__dirname+"/data/ControllerA.js") ;
			...
			(new loader.ControllerPath("opencomb/test/TDD/mvc/data/ControllerA:bbb")).xpath.should.eql(["bbb"]) ;
			...
			(new loader.ControllerPath("./data/ControllerA:ccc",__dirname)).loadDefine()
					.pathname(pkgsmgr).should.be.eql("opencomb/test/TDD/mvc/data/ControllerA:ccc") ;
